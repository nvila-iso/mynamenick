    ...
    <>
      <ScreenTemplate>
        ...
        <div className="flex flex-col gap-2 border-2 border-zinc-500 p-1 rounded-md">
          ...
          {/*Stats*/}
          <div className="border-2 border-zinc-500 p-1 rounded-md text-sm grid grid-cols-2 items-center ">
            {/*Stats Row */}

            <p className="font-semibold">Adaptable +4</p>
            <div className="w-15 h-3 border-2 rounded-lg">
              <div className="w-10 h-2 bg-black/30"></div>
            </div>

            <p className="font-semibold">Creativity +5</p>
            <div className="w-15 h-3 border-2 rounded-lg">
              <div className="w-12 h-2 bg-black/30"></div>
            </div>
            <p className="font-semibold">Communication +4</p>
            <div className="w-15 h-3 border-2 rounded-lg">
              <div className="w-12 h-2 bg-black/30"></div>
            </div>
            <p className="font-semibold">Passion for Games & Media +MAX</p>
            <div className="w-15 h-3 border-2 rounded-lg">
