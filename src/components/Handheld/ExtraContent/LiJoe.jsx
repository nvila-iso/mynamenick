  ...
  return (
    <>
      ...
      <p>
        ...
        and producing tournament content. Highlights include co-running "Beta
        Bash", one of the first Street Fighter V beta tournaments, where I
        created all promotional graphics and developed a custom animated
        scoreboard in After Effects.
      </p>
    </>
  );
};
